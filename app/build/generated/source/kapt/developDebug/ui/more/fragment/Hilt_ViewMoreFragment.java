...
public abstract class Hilt_ViewMoreFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_ViewMoreFragment() {
    super();
  }

  Hilt_ViewMoreFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((ViewMoreFragment_GeneratedInjector) this.generatedComponent()).injectViewMoreFragment(UnsafeCasts.<ViewMoreFragment>unsafeCast(this));
    }
  }
